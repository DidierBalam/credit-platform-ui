<template>
  <div v-if="!isLoading && !isErrorProcess" class="user-creator">
    <div class="-flex -items-center" style="margin-top: -1.5em">
      ...
      <p class="-title -black -extra-bold -mld3">Actualiza los datos</p>
    </div>
    <div class="inp -mt3">
      <input
        type="text"
    ...
    <div class="-mt3 -flex-center">
      ...
      <button class="btn primary-btn -wd50 -ml2" @click="update()">
        <p>Guardar</p>
      </button>
    </div>
  </div>
  ...
  setup() {
    ...
    const update = () => {
      if (user.username && user.password) {
        ...
        createProcessTitle.value = "Actualizando";
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            store
              .dispatch(UserActionOptions.updateUser, user)
